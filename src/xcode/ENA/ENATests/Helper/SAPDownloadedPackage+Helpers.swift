...
extension SAPDownloadedPackage {
	...
	static func makeSignature(data: Data, key: P256.Signing.PrivateKey, bundleId: String = "si.gov.ostanizdrav") throws -> SAP_TEKSignature {
	...
	static func makeSignatureInfo(bundleId: String = "si.gov.ostanizdrav") -> SAP_SignatureInfo {
