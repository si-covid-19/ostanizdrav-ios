...
enum AppStrings {
	...
	enum Links {
		...
		static let exposureDetectionFAQ = NSLocalizedString("ExposureDetection_high_faq_URL", comment: "")
		static let healthCertificateErrorFAQ = NSLocalizedString("HealthCertificate_Error_FAQ_Link", comment: "")
		static let testCertificateErrorFAQ = NSLocalizedString("TestCertificate_Error_FAQ_Link", comment: "")
		static let findTestCentersFAQ = NSLocalizedString("Test_Centers_FAQ_Link", comment: "")
		static let healthCertificateValidationFAQ = NSLocalizedString("HealthCertificate_Info_validation_FAQLink", comment: "")
		static let healthCertificateValidationEU = NSLocalizedString("HealthCertificate_Info_validation_EULink", comment: "")
		static let invalidSignatureFAQ = NSLocalizedString("HealthCertificate_InvalidSignature_FAQLink", comment: "")
		static let statisticsInfoBlog = NSLocalizedString("Statistics_Info_Blog_Link", comment: "")
		static let healthCertificatePrintFAQ = NSLocalizedString("HealthCertificate_Print_FAQ_Link",  comment: "")
		static let healthCertificateBoosterFAQ = NSLocalizedString("HealthCertificate_Booster_FAQLink", comment: "")
		static let notificationSettingsFAQ = NSLocalizedString("NotificationSettings_FAQLink", comment: "")
		static let ticketValidationNoValidDCCFAQ = NSLocalizedString("TicketValidation_NoValidDCC_FAQLink", comment: "")
		static let ticketValidationServiceResultFAQ = NSLocalizedString("TicketValidation_ServiceResult_FAQLink", comment: "")
		static let healthCertificateAdmissionPolicyFAQ = NSLocalizedString("HealthCertificate_AdmissionPolicy_FAQLink", comment: "")
		static let selfQuarantineFAQ = NSLocalizedString("Risk_Voluntary_Self_Quarantine_FAQ_URL", comment: "")
		static let quarantineMeasuresFAQ = NSLocalizedString("Risk_Quarantine_Measures_FAQ_URL", comment: "")
		static let coronaWarnAppStoreLink = NSLocalizedString("TicketValidation_CoronaWarnAppLink", comment: "")
	}
	...
	enum ExposureSubmission {
		...
		enum AntigenTest {
			...
			enum Information {
				...
				enum legal {
					static let title = NSLocalizedString("ExposureSubmission_Antigen_Profile_Legal_Headline", comment: "")
					static let text01 = NSLocalizedString("ExposureSubmission_Antigen_Profile_Legal_Text01", comment: "")
					static let text02 = NSLocalizedString("ExposureSubmission_Antigen_Profile_Legal_Text02", comment: "")
					static let text03 = NSLocalizedString("ExposureSubmission_Antigen_Profile_Legal_Text03", comment: "")
					static let text04 = NSLocalizedString("ExposureSubmission_Antigen_Profile_Legal_Text04", comment: "")
					static let text05 = NSLocalizedString("ExposureSubmission_Antigen_Profile_Legal_Text05", comment: "")
					static let text06 = NSLocalizedString("ExposureSubmission_Antigen_Profile_Legal_Text06", comment: "")
					static let text07 = NSLocalizedString("ExposureSubmission_Antigen_Profile_Legal_Text07", comment: "")
				}
		...
		enum TestCertificate {
			enum Info {
				...
				static let legalHeadline_1 = NSLocalizedString("ExposureSubmission_TestCertificate_Information_Legal_Headline", comment: "")
				static let legalText_1 = NSLocalizedString("ExposureSubmission_TestCertificate_Information_Legal_Text_1", comment: "")
				static let legalText_2 = NSLocalizedString("ExposureSubmission_TestCertificate_Information_Legal_Text_2", comment: "")
				static let legalText_2a_PCR = NSLocalizedString("ExposureSubmission_TestCertificate_Information_Legal_Text_2a_PCR", comment: "")
				static let legalText_3 = NSLocalizedString("ExposureSubmission_TestCertificate_Information_Legal_Text_3", comment: "")
				static let legalText_4 = NSLocalizedString("ExposureSubmission_TestCertificate_Information_Legal_Text_4", comment: "")
				static let legalText_5 = NSLocalizedString("ExposureSubmission_TestCertificate_Information_Legal_Text_5", comment: "")
	...
	enum ExposureSubmissionQRInfo {
		...
		static let acknowledgementTitle = NSLocalizedString("ExposureSubmissionQRInfo_acknowledgement_legal_title", comment: "")
		static let acknowledgementBody = NSLocalizedString("ExposureSubmissionQRInfo_acknowledgement_legal_body", comment: "")
		static let acknowledgementBullet1_1 = NSLocalizedString("ExposureSubmissionQRInfo_acknowledgement_legal_Bullet1_1", comment: "")
		static let acknowledgementBullet1_2 = NSLocalizedString("ExposureSubmissionQRInfo_acknowledgement_legal_Bullet1_2", comment: "")
		static let acknowledgementBullet2 = NSLocalizedString("ExposureSubmissionQRInfo_acknowledgement_legal_Bullet2", comment: "")
		static let acknowledgementBullet3 = NSLocalizedString("ExposureSubmissionQRInfo_acknowledgement_legal_Bullet3", comment: "")
		static let acknowledgementWithdrawConsent = NSLocalizedString("ExposureSubmissionQRInfo_acknowledgement_legal_WithdrawConsent", comment: "")
	...
	enum ExposureSubmissionWarnOthers {
		...
		static let acknowledgementTitle = NSLocalizedString("ExposureSubmissionWarnOthers_acknowledgementTitle", comment: "")
		static let acknowledgementBody = NSLocalizedString("ExposureSubmissionWarnOthers_acknowledgementBody", comment: "")
		static let acknowledgement_1_1 = NSLocalizedString("ExposureSubmissionWarnOthers_acknowledgement_1_1", comment: "")
		static let acknowledgement_1_2 = NSLocalizedString("ExposureSubmissionWarnOthers_acknowledgement_1_2", comment: "")
		static let acknowledgement_footer = NSLocalizedString("ExposureSubmissionWarnOthers_acknowledgement_footer", comment: "")
	...
	enum SurveyConsent {
		...
		static let surveyDetailsLegalHeader = NSLocalizedString("SurveyConsent_Legal_Details_Headline", comment: "")
	...
	enum Home {
		...
		static let daysSinceInstallation = NSLocalizedString("Home_Risk_Days_Since_Installation_Title", comment: "")
		static let riskEncounterLowFAQLink = NSLocalizedString("Risk_Encounter_Low_FAQ_URL", comment: "")
	...
	enum SafariView {
		...
		static let socialMedia = NSLocalizedString("safari_corona_social_media", comment: "")
	}
	...
	enum NewVersionFeatures {
		...
		static let feature218TrashTitle = NSLocalizedString("NewVersionFeature_218_trash_title", comment: "")
		static let feature218TrashDescription = NSLocalizedString("NewVersionFeature_218_trash_description", comment: "")
	}
	...
	enum DeltaOnboarding {
		...
		static let legalDataProcessingInfoTitle = NSLocalizedString("DeltaOnboarding_DataProcessing_Info_title", comment: "")
		static let legalDataProcessingInfoContent = NSLocalizedString("DeltaOnboarding_DataProcessing_Info_content", comment: "")
	...
	enum AutomaticSharingConsent {
		...
		static let consentDescriptionPart5 = NSLocalizedString("AutomaticSharingConsent_DescriptionPart5", comment: "")
	...
	enum ContactDiary {
		...
		enum Information {
			...
			static let legalHeadline_1 = NSLocalizedString("ContactDiary_Information_Legal_Headline_1", comment: "")
			static let legalSubHeadline_1 = NSLocalizedString("ContactDiary_Information_Legal_SubHeadline_1", comment: "")
			static let legalSubHeadline_2 = NSLocalizedString("ContactDiary_Information_Legal_SubHeadline_2", comment: "")
			static let legalText_1 = NSLocalizedString("ContactDiary_Information_Legal_Text_1", comment: "")
			static let legalText_2 = NSLocalizedString("ContactDiary_Information_Legal_Text_2", comment: "")
			static let legalText_3 = NSLocalizedString("ContactDiary_Information_Legal_Text_3", comment: "")
			static let legalText_4 = NSLocalizedString("ContactDiary_Information_Legal_Text_4", comment: "")
	...
	enum Statistics {
		...
		enum Info {
			...
			static let faqLink = NSLocalizedString("Statistics_Info_FAQ_URL", comment: "")
	...
	enum DataDonation {
		...
		enum Info {
			...
			static let legalTitle = NSLocalizedString("DataDonation_Acknowledgement_Title", comment: "")
			static let legalAcknowledgementContent = NSLocalizedString("DataDonation_Acknowledgement_Content", comment: "")
			static let legalAcknowledgementBulletPoint1 = NSLocalizedString("DataDonation_Acknowledgement_BulletPoint_1", comment: "")
			static let legalAcknowledgementBulletPoint2 = NSLocalizedString("DataDonation_Acknowledgement_BulletPoint_2", comment: "")
			static let legalAcknowledgementBulletPoint3 = NSLocalizedString("DataDonation_Acknowledgement_BulletPoint_3", comment: "")
		...
		enum DetailedInfo {
			...
			static let legalHeadline = NSLocalizedString("DataDonation_DetailedInformation_Headline", comment: "")
			static let legalParagraph = NSLocalizedString("DataDonation_DetailedInformation_Text", comment: "")
		...
		enum AppSettings {
			static let ppaSettingsPrivacyInformationBody = NSLocalizedString("ppa_settings_privacy_information_body", comment: "")
		}
	}
	...
	enum ErrorReport {
		...
		static let faqURL = NSLocalizedString("errorReport_FAQ_URL", comment: "")
		...
		enum Legal {
			static let dataPrivacy_Headline = NSLocalizedString("errorReport_Legal_DataPrivacy_Headline", comment: "")
			static let dataPrivacy_Bullet1 = NSLocalizedString("errorReport_Legal_DataPrivacy_Bullet1", comment: "")
			static let dataPrivacy_Bullet2 = NSLocalizedString("errorReport_Legal_DataPrivacy_Bullet2", comment: "")
			static let dataPrivacy_Bullet3 = NSLocalizedString("errorReport_Legal_DataPrivacy_Bullet3", comment: "")
			static let dataPrivacy_Bullet4 = NSLocalizedString("errorReport_Legal_DataPrivacy_Bullet4", comment: "")
			static let dataPrivacy_Bullet5 = NSLocalizedString("errorReport_Legal_DataPrivacy_Bullet5", comment: "")
			
			static let consent_Headline = NSLocalizedString("errorReport_Legal_Consent_Headline", comment: "")
			static let consent_Intro = NSLocalizedString("errorReport_Legal_Consent_Intro", comment: "")
			static let consent_Bullet1_Header = NSLocalizedString("errorReport_Legal_Consent_Bullet1_Header", comment: "")
			static let consent_Bullet1_Paragraph = NSLocalizedString("errorReport_Legal_Consent_Bullet1_Paragraph", comment: "")
			static let consent_Bullet2 = NSLocalizedString("errorReport_Legal_Consent_Bullet2", comment: "")
			static let consent_Last_Paragraph = NSLocalizedString("errorReport_Legal_Consent_LastParagraph", comment: "")
			
			static let sendReports_Headline = NSLocalizedString("errorReport_Legal_SendReports_Headline", comment: "")
			static let sendReports_Subline = NSLocalizedString("errorReport_Legal_SendReports_Subline", comment: "")
			static let sendReports_Bullet1_Part1 = NSLocalizedString("errorReport_Legal_SendReports_Bullet1_Part1", comment: "")
			static let sendReports_Bullet1_Part2 = NSLocalizedString("errorReport_Legal_SendReports_Bullet1_Part2", comment: "")
			static let sendReports_Bullet2 = NSLocalizedString("errorReport_Legal_SendReports_Bullet2", comment: "")
			static let sendReports_Paragraph = NSLocalizedString("errorReport_Legal_SendReports_Paragraph", comment: "")
		}
	...
	enum Checkins {
		...
		enum Information {
			...
			static let legalHeadline01 = NSLocalizedString("Checkin_Information_Legal_Headline_1", comment: "")
			static let legalSubHeadline01 = NSLocalizedString("Checkin_Information_Legal_SubHeadline_1", comment: "")
			static let legalSubHeadline02 = NSLocalizedString("Checkin_Information_Legal_SubHeadline_2", comment: "")
			static let legalText01bold = NSLocalizedString("Checkin_Information_Legal_Text_1_bold", comment: "")
			static let legalText01normal = NSLocalizedString("Checkin_Information_Legal_Text_1_normal", comment: "")
			static let legalText02 = NSLocalizedString("Checkin_Information_Legal_Text_2", comment: "")
			static let legalText03 = NSLocalizedString("Checkin_Information_Legal_Text_3", comment: "")
	...
	enum TraceLocations {
		...
		enum Information {
			...
			static let legalHeadline = NSLocalizedString("TraceLocation_Information_Legal_Headline_1", comment: "")

			static let legalText01 = NSLocalizedString("TraceLocation_Information_Legal_Text_1", comment: "")
			static let legalText02bold = NSLocalizedString("TraceLocation_Information_Legal_Text_2_bold", comment: "")
			static let legalText02 = NSLocalizedString("TraceLocation_Information_Legal_Text_2", comment: "")
			static let legalText03bold = NSLocalizedString("TraceLocation_Information_Legal_Text_3_bold", comment: "")
			static let legalText03 = NSLocalizedString("TraceLocation_Information_Legal_Text_3", comment: "")
			static let legalText04 = NSLocalizedString("TraceLocation_Information_Legal_Text_4", comment: "")
			static let legalText05 = NSLocalizedString("TraceLocation_Information_Legal_Text_5", comment: "")
			static let dataPrivacyTitle = NSLocalizedString("Checkin_Information_Dataprivacy_Title", comment: "")
	...
	enum CovPass {
		enum Information {
			...
			static let faqLink = NSLocalizedString("CovPass_Check_FAQLink", comment: "")
	...
	enum HealthCertificate {
		...
		enum Info {
			...
			enum Legal {
				static let headline = NSLocalizedString("HealthCertificate_Info_Legal_headline", comment: "")
				static let section01 = NSLocalizedString("HealthCertificate_Info_Legal_section01", comment: "")
				static let section02 = NSLocalizedString("HealthCertificate_Info_Legal_section02", comment: "")
				static let section03 = NSLocalizedString("HealthCertificate_Info_Legal_section03", comment: "")
				static let section04 = NSLocalizedString("HealthCertificate_Info_Legal_section04", comment: "")
			}
	...
	enum UniversalQRScanner {
		...
		enum MaxPersonAmountAlert {
			...
			static let covPassCheckLink = NSLocalizedString("UniversalQRScanner_MaxPersonAmountAlert_CovPassCheckLink", comment: "")
			static let faqButton = NSLocalizedString("UniversalQRScanner_MaxPersonAmountAlert_faqButton", comment: "")
			static let faqLink = NSLocalizedString("UniversalQRScanner_MaxPersonAmountAlert_FAQLink", comment: "")
		}
	...
	enum TicketValidation {
		enum FirstConsent {
			...
			enum Legal {
				static let title = NSLocalizedString("TicketValidation_FirstConsent_Legal_title", comment: "")
				static let subtitle = NSLocalizedString("TicketValidation_FirstConsent_Legal_subtitle", comment: "")
				static let bulletPoint1 = NSLocalizedString("TicketValidation_FirstConsent_Legal_bulletPoint1", comment: "")
				static let bulletPoint2 = NSLocalizedString("TicketValidation_FirstConsent_Legal_bulletPoint2", comment: "")
			}
		}
		...
		enum SecondConsent {
			...
			enum Legal {
				static let title = NSLocalizedString("TicketValidation_SecondConsent_Legal_title", comment: "")
				static let subtitle = NSLocalizedString("TicketValidation_SecondConsent_Legal_subtitle", comment: "")
				static let bulletPoint1 = NSLocalizedString("TicketValidation_SecondConsent_Legal_bulletPoint1", comment: "")
				static let bulletPoint2 = NSLocalizedString("TicketValidation_SecondConsent_Legal_bulletPoint2", comment: "")
				static let subBulletPoint1 = NSLocalizedString("TicketValidation_SecondConsent_Legal_subBulletPoint1", comment: "")
				static let subBulletPoint2 = NSLocalizedString("TicketValidation_SecondConsent_Legal_subBulletPoint2", comment: "")
				static let subBulletPoint3 = NSLocalizedString("TicketValidation_SecondConsent_Legal_subBulletPoint3", comment: "")
				static let subBulletPoint4 = NSLocalizedString("TicketValidation_SecondConsent_Legal_subBulletPoint4", comment: "")
			}
