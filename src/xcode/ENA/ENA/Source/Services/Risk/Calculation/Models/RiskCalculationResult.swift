...
extension Risk.Details {
	...
	init(
		...
		self.init(
			...
			minimumDistinctEncountersWithCurrentRiskLevel: minimumDistinctEncountersWithCurrentRiskLevel
		)
	}
...
extension Risk {
	...
	init(
		...
		self.init(
			...
			details: Details(activeTracing: activeTracing, riskCalculationResult: riskCalculationResult, minimumDistinctEncountersWithCurrentRiskLevel: riskCalculationResult.minimumDistinctEncountersWithCurrentRiskLevel),
